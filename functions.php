 ...
 */
function wilbur_register_styles() {
...
add_action( 'wp_enqueue_scripts', 'wilbur_register_styles' );

/**
 * Register and Enqueue Scripts.
 */
function wilbur_register_scripts() {
...
add_action( 'wp_enqueue_scripts', 'wilbur_register_scripts' );
 ...
 */
function wilbur_skip_link_focus_fix() {
...
add_action( 'wp_print_footer_scripts', 'wilbur_skip_link_focus_fix' );
...
add_action( 'wp_enqueue_scripts', 'wilbur_non_latin_languages' );

/**
 * Register navigation menus uses wp_nav_menu in five places.
 */
function wilbur_menus() {
 ...
 * @return string
 */
function wilbur_get_custom_logo( $html ) {
...
add_filter( 'get_custom_logo', 'wilbur_get_custom_logo' );
 ...
 */
function wilbur_sidebar_registration() {
...
add_action( 'widgets_init', 'wilbur_sidebar_registration' );
 ...
 */
function wilbur_classic_editor_styles() {
...
add_action( 'init', 'wilbur_classic_editor_styles' );
 ...
 */
function wilbur_add_classic_editor_customizer_styles( $mce_init ) {
...
add_filter( 'tiny_mce_before_init', 'wilbur_add_classic_editor_customizer_styles' );
...
add_filter( 'tiny_mce_before_init', 'wilbur_add_classic_editor_non_latin_styles' );

/**
 * Block Editor Settings.
 * Add custom colors and font sizes to the block editor.
 */
function wilbur_block_editor_settings() {
	...
	$editor_color_palette = array(
		array(
			...
			'slug'  => 'accent',
			'color' => wilbur_get_color_for_area( 'content', 'accent' ),
		),
		array(
			'name'  => __( 'Primary', 'wilbur' ),
			'slug'  => 'primary',
			'color' => wilbur_get_color_for_area( 'content', 'text' ),
		),
		array(
			'name'  => __( 'Secondary', 'wilbur' ),
			'slug'  => 'secondary',
			'color' => wilbur_get_color_for_area( 'content', 'secondary' ),
		),
		array(
			'name'  => __( 'Subtle Background', 'wilbur' ),
			'slug'  => 'subtle-background',
			'color' => wilbur_get_color_for_area( 'content', 'borders' ),
		),
	);
	...
	if ( '#ffffff' === strtolower( wilbur_get_color_for_area( 'content', 'text' ) ) ) {
		add_theme_support( 'dark-editor-style' );
	}

}

add_action( 'after_setup_theme', 'wilbur_block_editor_settings' );
 ...
 * @return string
 */
function wilbur_read_more_tag( $html ) {
	return preg_replace( '/<a(.*)>(.*)<\/a>/iU', sprintf( '<div class="read-more-button-wrap"><a$1><span class="faux-button">$2</span> <span class="screen-reader-text">"%1$s"</span></a></div>', get_the_title( get_the_ID() ) ), $html );
}

add_filter( 'the_content_more_link', 'wilbur_read_more_tag' );
 ...
 * @return void
 */
function wilbur_customize_controls_enqueue_scripts() {
	$theme_version = wp_get_theme()->get( 'Version' );
 ...
 */
function wilbur_get_color_for_area( $area = 'content', $context = 'text' ) {
